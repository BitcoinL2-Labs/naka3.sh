...
function playbook_resume() {
   ...
   "$naka3" -c "./config-bitcoind-3.sh" bitcoind resume
   "$naka3" -c "./config-bitcoind-4.sh" bitcoind resume
   "$naka3" -c "./config-bitcoind-5.sh" bitcoind resume
   ...
   # boot follower nodes
   "$naka3" -c "./config-follower-0.sh" node 3 resume
   "$naka3" -c "./config-follower-1.sh" node 4 resume
   "$naka3" -c "./config-follower-2.sh" node 5 resume
}

function playbook_stop() {
   "$naka3" tx end-transfers "/tmp/three-miners-three-signing-followers/end-transfers"
